...
<head>
  ...
  <title>Sistma Veterinária | Consulta Cliente</title>
  ...
  <main class="col-6">
    <form action="javascript:void(0);">
      <div class="mb-3 col-5">
        ...
        <input type="text" class="form-control" id="txtNome" name="txtNome" placeholder="Nome do Cliente" onkeyup="search()" required>
      </div>
    </form>
